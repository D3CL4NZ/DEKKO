...
class DiscordWebhookSender:
    ...
    async def send(self, content: str = MISSING, *, username: str = MISSING, avatar_url: Any = MISSING, tts: bool = False, ephemeral: bool = False, file: discord.File = MISSING, files: Sequence[discord.File] = MISSING, embed: discord.Embed = MISSING, embeds: Sequence[discord.Embed] = MISSING, allowed_mentions: discord.AllowedMentions = MISSING, view: discord.View = MISSING, thread: discord.Snowflake = MISSING, thread_name: str = MISSING, wait: bool = False, suppress_embeds: bool = False, silent: bool = False, applied_tags: List[discord.ForumTag] = MISSING, poll: discord.Poll = MISSING):
